    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="register form ${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
          ...
          <#if !realm.registrationEmailAsUsername>
            ...
            <div class="register-field ${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('Biography',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="biography" class="${properties.kcLabelClass!}">${msg("biography")}</label>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" id="biography" class="form-control ${properties.kcInputClass!}" name="biography" value="${(register.formData.biography!'')}" />
                </div>
            </div>

            <div class="register-field ${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('Location',properties.kcFormGroupErrorClass!)}">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="location" class="${properties.kcLabelClass!}">${msg("location")}</label>
                </div>
                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" id="location" class="form-control ${properties.kcInputClass!}" name="location" value="${(register.formData.location!'')}" />
                </div>
            </div>
